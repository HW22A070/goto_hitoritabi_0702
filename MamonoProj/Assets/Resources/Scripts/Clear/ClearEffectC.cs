...
public class ClearEffectC : MonoBehaviour
{
    ...
    private void VirusEf()
    {
        ...
        Instantiate(_virusEf, _posOwn+new Vector3(Random.Range(-300, 300 + 1), Random.Range(-100, 100 + 1),0), rot).ShotEXP(angle, 0.1f, 1.0f);
