...
public class MechaZombieC : MonoBehaviour
{
    ...
    [SerializeField]
    private Sprite _beam, _bullet, _bomb,_fire,_transfomation;
    ...
    [SerializeField]
    private ExpC jet, SwingP,_prhbTargetEffect,_prfbFlashEffect;
    ...
    private IEnumerator ActionBranch()
    {
        ...
        else
        {
            ...
            switch (_attackMode)
            {
                ...
                //召喚
                case 4:
                    _movingCoroutine = StartCoroutine(DoSummonUnit(1));
                    break;
                //移動
                case 5:
                    _movingCoroutine = StartCoroutine(Move(true));
