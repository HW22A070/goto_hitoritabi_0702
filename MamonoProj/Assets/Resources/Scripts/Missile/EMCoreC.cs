...
public class EMCoreC : MonoBehaviour
{
    ...
    private int _destroyToPM;

    [SerializeField]
    [Tooltip("座標削除")]
    private bool _right = true, _left = true, _up = true, _down = true,_palyerDelete=true;

    [SerializeField, Tooltip("この弾に当たった時に発生する無敵時間")]
    private float _HitInvincible = 0.5f;

    /// <summary>
    /// 敵と自機弾の衝突判定
    /// </summary>
    private RaycastHit2D _hitEmissileToPlayer;
